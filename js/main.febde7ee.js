 ...
 */
function isInt(a) {
  return Math.floor(a) == a && $.isNumeric(a)
}
!function (a, b) {
  function c(a) {
    var b = a.length
  ...
  function e(a, c, d, e) {
    if (kb.acceptData(a)) {
      var f, g, h = kb.expando, i = a.nodeType, j = i ? kb.store : a, k = i ? a[h] : a[h] && h;
      if (k && j[k] && (e || j[k].data) || d !== b || "string" != typeof c)
        return k || (k = i ? a[h] = bb.pop() || kb.guid++ : h),
          ...
          "string" == typeof c ? (f = g[c],
            null == f && (f = g[kb.camelCase(c)])) : f = g,
          f
    }
  }
  function f(a, b, c) {
    if (kb.acceptData(a)) {
      var d, e, f = a.nodeType, g = f ? kb.store : a, i = f ? a[kb.expando] : kb.expando;
      if (g[i]) {
        ...
        (c || (delete g[i].data,
          h(g[i]))) && (f ? kb.cleanData([a], !0) : kb.support.deleteExpando || g != g.window ? delete g[i] : g[i] = null)
      }
    }
  }
  function g(a, c, d) {
  ...
  function t(a, b) {
    ...
    if (1 === b.nodeType) {
      if (c = b.nodeName.toLowerCase(),
        !kb.support.noCloneEvent && b[kb.expando]) {
        e = kb._data(b);
        for (d in e.events)
  ...
  function y(a, b) {
    for (var c, d, e, f = [], g = 0, h = a.length; h > g; g++)
      d = a[g],
        d.style && (f[g] = kb._data(d, "olddisplay"),
          c = d.style.display,
          b ? (f[g] || "none" !== c || (d.style.display = ""),
            "" === d.style.display && x(d) && (f[g] = kb._data(d, "olddisplay", C(d.nodeName)))) : f[g] || (e = x(d),
    ...
    for (var f = c === (d ? "border" : "content") ? 4 : "width" === b ? 1 : 0, g = 0; 4 > f; f += 2)
      "margin" === c && (g += kb.css(a, c + xc[f], !0, e)),
        d ? ("content" === c && (g -= kb.css(a, "padding" + xc[f], !0, e)),
          "margin" !== c && (g -= kb.css(a, "border" + xc[f] + "Width", !0, e))) : (g += kb.css(a, "padding" + xc[f], !0, e),
  ...
  function C(a) {
    var b = Y
      , c = uc[a];
    return c || (c = D(a, b),
      "none" !== c && c || (jc = (jc || kb("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(b.documentElement),
  ...
  var U, V, W = typeof b, X = a.location, Y = a.document, Z = Y.documentElement, $ = a.jQuery, _ = a.$, ab = {}, bb = [], cb = "1.10.0", db = bb.concat, eb = bb.push, fb = bb.slice, gb = bb.indexOf, hb = ab.toString, ib = ab.hasOwnProperty, jb = cb.trim, kb = function (a, b) {
    ...
    Y.addEventListener ? (Y.removeEventListener("DOMContentLoaded", xb, !1),
      a.removeEventListener("load", xb, !1)) : (Y.detachEvent("onreadystatechange", xb),
  ...
  kb.fn = kb.prototype = {
    ...
    init: function (a, c, d) {
      ...
      if ("string" == typeof a) {
        ...
        if (e[1]) {
          if (c = c instanceof kb ? c[0] : c,
            kb.merge(this, kb.parseHTML(e[1], c && c.nodeType ? c.ownerDocument || c : Y, !0)),
            pb.test(e[1]) && kb.isPlainObject(c))
            for (e in c)
      ...
      return a.nodeType ? (this.context = this[0] = a,
        this.length = 1,
        this) : kb.isFunction(a) ? d.ready(a) : (a.selector !== b && (this.selector = a.selector,
    ...
    kb.extend = kb.fn.extend = function () {
      ...
      for ("boolean" == typeof h && (k = h,
        h = arguments[1] || {},
        i = 2),
        "object" == typeof h || kb.isFunction(h) || (h = {}),
        j === i && (h = this,
          --i); j > i; i++)
        if (null != (f = arguments[i]))
          for (e in f)
            a = h[e],
              d = f[e],
              "__proto__" !== e && h !== d && (k && d && (kb.isPlainObject(d) || (c = kb.isArray(d))) ? (c ? (c = !1,
                g = a && kb.isArray(a) ? a : []) : g = a && kb.isPlainObject(a) ? a : {},
    ...
    kb.extend({
      ...
      ready: function (a) {
        if (a === !0 ? !--kb.readyWait : !kb.isReady) {
          ...
          kb.isReady = !0,
            a !== !0 && --kb.readyWait > 0 || (U.resolveWith(Y, [kb]),
              kb.fn.trigger && kb(Y).trigger("ready").off("ready"))
        }
      },
      ...
      parseHTML: function (a, b, c) {
        ...
        var d = pb.exec(a)
          , e = !c && [];
        return d ? [b.createElement(d[1])] : (d = kb.buildFragment([a], b, e),
          e && kb(e).remove(),
          kb.merge([], d.childNodes))
      },
      parseJSON: function (b) {
        return a.JSON && a.JSON.parse ? a.JSON.parse(b) : null === b ? b : "string" == typeof b && (b = kb.trim(b),
          b && qb.test(b.replace(sb, "@").replace(tb, "]").replace(rb, ""))) ? new Function("return " + b)() : void kb.error("Invalid JSON: " + b)
      },
      parseXML: function (c) {
        var d, e;
      ...
      proxy: function (a, c) {
        ...
        return "string" == typeof c && (f = a[c],
          c = a,
          a = f),
          kb.isFunction(a) ? (d = fb.call(arguments, 2),
            e = function () {
    ...
    kb.ready.promise = function (b) {
      if (!U)
        if (U = kb.Deferred(),
          ...
          Y.addEventListener("DOMContentLoaded", xb, !1),
  ...
  */
    function (a, b) {
        ...
        if (M && !d) {
          if (e = xb.exec(a))
            if (g = e[1]) {
              ...
              if (e[2])
                return eb.apply(c, b.getElementsByTagName(a)),
                  c;
              if ((g = e[3]) && B.getElementsByClassName && b.getElementsByClassName)
                return eb.apply(c, b.getElementsByClassName(g)),
                  c
            }
          if (B.qsa && (!N || !N.test(a))) {
            if (l = k = R,
              ...
              for (j = p(a),
                (k = b.getAttribute("id")) ? l = k.replace(Ab, "\\$&") : b.setAttribute("id", l),
                l = "[id='" + l + "'] ",
                i = j.length; i--;)
                j[i] = l + q(j[i]);
      ...
      function p(a, b) {
        ...
        for (h = a,
          i = [],
          j = D.preFilter; h;) {
          (!d || (e = pb.exec(h))) && (e && (h = h.slice(e[0].length) || h),
            i.push(f = [])),
            d = !1,
            (e = qb.exec(h)) && (d = e.shift(),
              f.push({
                value: d,
                type: e[0].replace(ob, " ")
              }),
              h = h.slice(d.length));
          for (g in D.filter)
            !(e = vb[g].exec(h)) || j[g] && !(e = j[g](e)) || (d = e.shift(),
              f.push({
                value: d,
                type: g,
                matches: e
      ...
      function y(a, b, c, d) {
        ...
        if (!d && 1 === j.length) {
          if (f = j[0] = j[0].slice(0),
            ...
            if (b = (D.find.ID(g.matches[0].replace(Bb, Cb), b) || [])[0],
              !b)
              return c;
            a = a.slice(f.shift().value.length)
          }
          for (e = vb.needsContext.test(a) ? 0 : f.length; e-- && (g = f[e],
            !D.relative[h = g.type]);)
      ...
      F = c.isXML = function (a) {
        ...
        J = c.setDocument = function (a) {
          ...
          return b !== K && 9 === b.nodeType && b.documentElement ? (K = b,
            L = b.documentElement,
            M = !F(b),
            ...
            O = [],
            N = [],
            (B.qsa = d(b.querySelectorAll)) && (g(function (a) {
          ...
          filter: {
            ...
            ATTR: function (a, b, d) {
              return function (e) {
                var f = c.attr(e, a);
                return null == f ? "!=" === b : b ? (f += "",
                  "=" === b ? f === d : "!=" === b ? f !== d : "^=" === b ? d && 0 === f.indexOf(d) : "*=" === b ? d && f.indexOf(d) > -1 : "$=" === b ? d && f.slice(-d.length) === d : "~=" === b ? (" " + f + " ").indexOf(d) > -1 : "|=" === b ? f === d || f.slice(0, d.length + 1) === d + "-" : !1) : !0
              }
            },
  ...
  kb.extend({
    ...
    hasData: function (a) {
      return a = a.nodeType ? kb.store[a[kb.expando]] : a[kb.expando],
        !!a && !h(a)
    },
    data: function (a, b, c) {
      return e(a, b, c)
    ...
    kb.fn.extend({
      data: function (a, c) {
        ...
        if (a === b) {
          if (this.length && (f = kb.data(i),
            1 === i.nodeType && !kb._data(i, "parsedAttrs"))) {
            for (d = i.attributes; h < d.length; h++)
              e = d[h].name,
                0 === e.indexOf("data-") && (e = kb.camelCase(e.slice(5)),
                  g(i, e, f[e]));
    ...
    kb.extend({
      queue: function (a, b, c) {
        ...
        return a ? (b = (b || "fx") + "queue",
          d = kb._data(a, b),
          c && (!d || kb.isArray(c) ? d = kb._data(a, b, kb.makeArray(c)) : d.push(c)),
          d || []) : void 0
      },
  ...
  kb.fn.extend({
      ...
      return this.each(kb.isFunction(a) ? function (c) {
        ...
        : function () {
          if ("string" === c)
            ...
            (c === W || "boolean" === c) && (this.className && kb._data(this, "__className__", this.className),
    ...
    val: function (a) {
      ...
      {
        if (arguments.length)
          return e = kb.isFunction(a),
            this.each(function (c) {
              var f;
              1 === this.nodeType && (f = e ? a.call(this, c, kb(this).val()) : a,
                null == f ? f = "" : "number" == typeof f ? f += "" : kb.isArray(f) && (f = kb.map(f, function (a) {
                  return null == a ? "" : a + ""
                })),
        ...
        if (f)
          return d = kb.valHooks[f.type] || kb.valHooks[f.nodeName.toLowerCase()],
    ...
    kb.extend({
      ...
      attr: function (a, c, d) {
        ...
        if (a && 3 !== g && 8 !== g && 2 !== g)
          return typeof a.getAttribute === W ? kb.prop(a, c, d) : (1 === g && kb.isXMLDoc(a) || (c = c.toLowerCase(),
            e = kb.attrHooks[c] || (kb.expr.match.bool.test(c) ? Db : Cb)),
            d === b ? e && "get" in e && null !== (f = e.get(a, c)) ? f : (f = kb.find.attr(a, c),
              null == f ? b : f) : null !== d ? e && "set" in e && (f = e.set(a, d, c)) !== b ? f : (a.setAttribute(c, d + ""),
                d) : void kb.removeAttr(a, c))
      },
  ...
  kb.event = {
    ...
    remove: function (a, b, c, d, e) {
      ...
      if (q && (k = q.events)) {
        ...
        kb.isEmptyObject(k) && (delete q.handle,
          kb._removeData(a, "events"))
      }
    },
    trigger: function (c, d, e, f) {
      var g, h, i, j, k, l, m, n = [e || Y], o = ib.call(c, "type") ? c.type : c, p = ib.call(c, "namespace") ? c.namespace.split(".") : [];
      if (i = l = e = e || Y,
        3 !== e.nodeType && 8 !== e.nodeType && !Ob.test(o + kb.event.triggered) && (o.indexOf(".") >= 0 && (p = o.split("."),
          o = p.shift(),
          p.sort()),
          h = o.indexOf(":") < 0 && "on" + o,
        ...
        if (!f && !k.noBubble && !kb.isWindow(e)) {
          for (j = k.delegateType || o,
            Ob.test(j + o) || (i = i.parentNode); i; i = i.parentNode)
            n.push(i),
              l = i;
        ...
        if (c.type = o,
          !f && !c.isDefaultPrevented() && (!k._default || k._default.apply(n.pop(), d) === !1) && kb.acceptData(e) && h && e[o] && !kb.isWindow(e)) {
          l = e[h],
            l && (e[h] = null),
    ...
    kb.Event = function (a, b) {
      return this instanceof kb.Event ? (a && a.type ? (this.originalEvent = a,
        ...
        void (this[kb.expando] = !0)) : new kb.Event(a, b)
    }
    ,
    kb.Event.prototype = {
    ...
    kb.each({
      ...
      kb.event.special[a] = {
        ...
        handle: function (a) {
          ...
          return (!e || e !== d && !kb.contains(d, e)) && (a.type = f.origType,
    ...
    kb.support.submitBubbles || (kb.event.special.submit = {
      ...
      postDispatch: function (a) {
        a._submit_bubble && (delete a._submit_bubble,
          this.parentNode && !a.isTrigger && kb.event.simulate("submit", this.parentNode, a, !0))
      },
      teardown: function () {
    ...
    kb.each({
      ...
      kb.fn[a] = function (c, d) {
        ...
        return "Until" !== a.slice(-5) && (d = c),
          ...
          this.length > 1 && (Tb[a] || (e = kb.unique(e)),
    ...
    kb.fn.extend({
      ...
      remove: function (a, b) {
        for (var c, d = a ? kb.filter(a, this) : this, e = 0; null != (c = d[e]); e++)
          b || 1 !== c.nodeType || kb.cleanData(u(c)),
            c.parentNode && (b && kb.contains(c.ownerDocument, c) && r(u(c, "script")),
        ...
        return kb.access(this, function (a) {
          ...
          if (!("string" != typeof a || ac.test(a) || !kb.support.htmlSerialize && Wb.test(a) || !kb.support.leadingWhitespace && Xb.test(a) || gc[(Zb.exec(a) || ["", ""])[1].toLowerCase()])) {
            ...
            try {
              for (; e > d; d++)
                c = this[d] || {},
                  1 === c.nodeType && (kb.cleanData(u(c, !1)),
                    c.innerHTML = a);
              c = 0
            } catch (f) { }
          }
      ...
      domManip: function (a, b, c) {
        ...
        if (k && (i = kb.buildFragment(a, this[0].ownerDocument, !1, !c && this),
          d = i.firstChild,
          1 === i.childNodes.length && (i = d),
          d)) {
          for (g = kb.map(u(i, "script"), p),
            f = g.length; k > j; j++)
            e = i,
              j !== m && (e = kb.clone(e, !0, !0),
                f && kb.merge(g, u(e, "script"))),
              b.call(this[j], e, j);
          if (f)
    ...
    kb.extend({
      clone: function (a, b, c) {
        ...
        if (kb.support.html5Clone || kb.isXMLDoc(a) || !Wb.test("<" + a.nodeName + ">") ? f = a.cloneNode(!0) : (ic.innerHTML = a.outerHTML,
          ...
          !(kb.support.noCloneEvent && kb.support.noCloneChecked || 1 !== a.nodeType && 11 !== a.nodeType || kb.isXMLDoc(a)))
          for (d = u(f),
            h = u(a),
            g = 0; null != (e = h[g]); ++g)
            d[g] && t(e, d[g]);
      ...
      buildFragment: function (a, b, c, d) {
        ...
        for (h && m.removeChild(h),
          kb.support.appendChecked || kb.grep(u(o, "input"), v),
          p = 0; f = o[p++];)
      ...
      cleanData: function (a, b) {
        for (var c, d, e, f, g = 0, h = kb.expando, i = kb.store, j = kb.support.deleteExpando, k = kb.event.special; null != (c = a[g]); g++)
          if ((b || kb.acceptData(c)) && (e = c[h],
            f = e && i[e])) {
            if (f.events)
              for (d in f.events)
  ...
  kb.fn.extend({
    ...
    kb.extend({
      ...
      style: function (a, c, d, e) {
        if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
          ...
          if (c = kb.cssProps[i] || (kb.cssProps[i] = w(j, i)),
            h = kb.cssHooks[c] || kb.cssHooks[i],
            d === b)
            return h && "get" in h && (f = h.get(a, !1, e)) !== b ? f : j[c];
          if (g = typeof d,
            "string" === g && (f = tc.exec(d)) && (d = (f[1] + 1) * f[2] + parseFloat(kb.css(a, c)),
              g = "number"),
            !(null == d || "number" === g && isNaN(d) || ("number" !== g || kb.cssNumber[i] || (d += "px"),
    ...
    kb.support.opacity || (kb.cssHooks.opacity = {
      ...
      set: function (a, b) {
        ...
        c.zoom = 1,
          (b >= 1 || "" === b) && "" === kb.trim(f.replace(mc, "")) && c.removeAttribute && (c.removeAttribute("filter"),
      ...
      kb.support.reliableMarginRight || (kb.cssHooks.marginRight = {
        ...
        !kb.support.pixelPosition && kb.fn.position && kb.each(["top", "left"], function (a, b) {
          kb.cssHooks[b] = {
            get: function (a, c) {
              return c ? (c = lc(a, b),
                sc.test(c) ? kb(a).position()[b] + "px" : c) : void 0
            }
          }
        })
    }),
  ...
  kb.fn.extend({
    ...
    kb.param = function (a, c) {
      ...
      if (c === b && (c = kb.ajaxSettings && kb.ajaxSettings.traditional),
        kb.isArray(a) || a.jquery && !kb.isPlainObject(a))
        kb.each(a, function () {
    ...
    kb.extend({
      ...
      ajax: function (a, c) {
        function d(a, c, d, e) {
          ...
          2 !== u && (u = 2,
            ...
            j && (o.trigger("ajaxComplete", [w, m]),
              --kb.active || kb.event.trigger("ajaxStop")))
        }
        "object" == typeof a && (c = a,
          a = b),
          c = c || {};
        ...
        if (p.promise(w).complete = q.add,
          ...
          m.dataTypes = kb.trim(m.dataType || "*").toLowerCase().match(mb) || [""],
          null == m.crossDomain && (e = Oc.exec(m.url.toLowerCase()),
            m.crossDomain = !(!e || e[1] === Ec[1] && e[2] === Ec[2] && (e[3] || ("http:" === e[1] ? "80" : "443")) === (Ec[3] || ("http:" === Ec[1] ? "80" : "443")))),
        ...
        j = m.global,
          ...
          g = m.url,
          m.hasContent || (m.data && (g = m.url += (Hc.test(g) ? "&" : "?") + m.data,
            delete m.data),
            m.store === !1 && (m.url = Jc.test(g) ? g.replace(Jc, "$1_=" + Gc++) : g + (Hc.test(g) ? "&" : "?") + "_=" + Gc++)),
          m.ifModified && (kb.lastModified[g] && w.setRequestHeader("If-Modified-Since", kb.lastModified[g]),
            kb.etag[g] && w.setRequestHeader("If-None-Match", kb.etag[g])),
        ...
        return {
          send: function (e, f) {
            ...
            i.send(c.hasContent && c.data || null),
              d = function (a, e) {
                ...
                try {
                  if (d && (e || 4 === i.readyState))
                    if (d = b,
                      g && (i.onreadystatechange = kb.noop,
                        Zc && delete Wc[g]),
                      e)
              ...
              ,
              c.async ? 4 === i.readyState ? setTimeout(d) : (g = ++Yc,
                Zc && (Wc || (Wc = {},
                  kb(a).unload(Zc)),
                  Wc[g] = d),
  ...
  kb.Animation = kb.extend(O, {
    ...
    kb.fn.offset = function (a) {
      ...
      if (g)
        return c = g.documentElement,
          kb.contains(c, f) ? (typeof f.getBoundingClientRect !== W && (e = f.getBoundingClientRect()),
            d = T(g),
          {
      ...
      position: function () {
        if (this[0]) {
          ...
          return "fixed" === kb.css(d, "position") ? b = d.getBoundingClientRect() : (a = this.offsetParent(),
            b = this.offset(),
            kb.nodeName(a[0], "html") || (c = a.offset()),
            c.top += kb.css(a[0], "borderTopWidth", !0),
    ...
    "object" == typeof module && "object" == typeof module.exports ? module.exports = kb : (a.jQuery = a.$ = kb,
  ...
  $.fn.cbTimeAgo = function (a) {
    var b = function (a, b) {
      "time" != !this.tagName && c($(b))
    }
      , c = function (b) {
        var c = e(b.attr("datetime"))
          , f = new Date;
        if (!(c > f)) {
          var g, h = function () {
            var b, d = (f.getTime() - c.getTime()) / 1e3 / 3600 / 24, e = d / 30, g = d / 365;
            return g > .9 ? (g = Math.round(g),
              "de" == a ? (b = "vor " + g + " Jahr",
                g > 1 && (b += "en")) : (b = g + " year",
                  g > 1 && (b += "s"),
                  b += " ago")) : e > 1 ? (e = Math.round(e),
                    "de" == a ? (b = "vor " + e + " Monat",
                      e > 1 && (b += "en")) : (b = e + " month",
                        e > 1 && (b += "s"),
                        b += " ago")) : (d = Math.round(d),
                          "de" == a ? (b = "vor " + d + " Tag",
                            d > 1 && (b += "en")) : (b = d + " day",
                              d > 1 && (b += "s"),
                              b += " ago")),
              b
          }, i = f.getFullYear() - c.getFullYear(), j = (f.getMonth() - c.getMonth()) % 12, k = new Date(f.getTime()), l = new Date(c.getTime());
          k.setHours(12),
            k.setMinutes(12),
            k.setSeconds(12),
            k.setMilliseconds(12),
            l.setHours(12),
            l.setMinutes(12),
            l.setSeconds(12),
            l.setMilliseconds(12);
          var m = Math.floor((k.getTime() - l.getTime()) / 1e3 / 3600 / 24)
            , n = function (a) {
              return 10 > a ? "0" + a : a
            }
            , o = function (a) {
          ...
          0 == m ? (g = "de" == a ? n(c.getHours()) + ":" + n(c.getMinutes()) : o(c),
            d(9e5, b)) : 1 == m ? (g = "de" == a ? "Gestern, " + n(c.getHours()) + ":" + n(c.getMinutes()) : "Yesterday, " + o(c),
              d(12e4, b)) : 0 == i && 0 == j ? (g = h(),
                d(18e5, b)) : (g = h(),
                  d(36e5, b)),
            b.text(g)
        }
